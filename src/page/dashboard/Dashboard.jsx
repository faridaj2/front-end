                                ...
                                <div key={index} className='rounded-lg p-2 flex shadow border-green-500 items-center gap-3 bg-gradient-to-b from-green-100 text-green-700'>
                                    ...
                                    <div className=''>
                                        <div className='flex gap-2'>
                                            ...
                                            <div className="text-xs rounded-full text-white font-normal bg-green-500 px-2 truncate">{item.an}</div>
                                        </div>
                                        <div className="text-sm font-semibold mt-1">{item.rekening}</div>
                                    </div>
